...
def main_cnn():
    ...
    # here the train_CNN_more function is the same as train_CNN function, I just add the parameters W and B into it
    # w_conv, b_conv, w_fc, b_fc = train_cnn_more(mini_batch_x, mini_batch_y, w_conv, b_conv, w_fc, b_fc)
    # sio.savemat('cnn.mat', mdict={'w_conv': w_conv, 'b_conv': b_conv, 'w_fc': w_fc, 'b_fc': b_fc})
